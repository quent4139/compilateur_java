...
# Encore un test simpliste. On compile un fichier (ecrit0.deca), on
...
NAME=./src/test/deca/codegen/valid/provided/cond0.deca
extension="${NAME##*.}"
filename="${NAME%.*}"
...
rm -f ./src/test/deca/codegen/valid/provided/condmvn 0.ass
